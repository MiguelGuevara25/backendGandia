...
export interface ApiJugadoresPrimerEquipoJugadoresPrimerEquipo
  extends Schema.CollectionType {
  collectionName: 'jugadores_primer_equipos';
  info: {
    singularName: 'jugadores-primer-equipo';
    pluralName: 'jugadores-primer-equipos';
    displayName: 'JugadoresPrimerEquipo';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    seccion: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::jugadores-primer-equipo.jugadores-primer-equipo',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNoticiaNoticia extends Schema.CollectionType {
  ...
  attributes: {
    ...
    url: Attribute.UID<'api::noticia.noticia', 'titulo'> & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::jugadores-primer-equipo.jugadores-primer-equipo': ApiJugadoresPrimerEquipoJugadoresPrimerEquipo;
